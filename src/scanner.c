...
/* Compile command: true "src/scanner.c" -I "/home/komo/Dev/tree-sitter-pluto/src"  -o "src/scanner" */
/* Compile hash: tMCWPZiwBWejJj8WZ3T3c3imp9d */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
#endif
#define NELUA_NIL (nlniltype){.x=0}
...
#endif
/* ------------------------------ DECLARATIONS ------------------------------ */
typedef struct ts_parser_allocator ts_parser_allocator;
typedef ts_parser_allocator* ts_parser_allocator_ptr;
struct ts_parser_allocator {char x;};
NELUA_STATIC_ASSERT(sizeof(ts_parser_allocator) == 1 && NELUA_ALIGNOF(ts_parser_allocator) == 1, "Nelua and C disagree on type size or align");
static NELUA_INLINE void* ts_parser_allocator_alloc(ts_parser_allocator_ptr self, uintptr_t size);
static NELUA_INLINE void* ts_parser_allocator_alloc0(ts_parser_allocator_ptr self, uintptr_t size);
static NELUA_INLINE void ts_parser_allocator_dealloc(ts_parser_allocator_ptr self, void* p);
static NELUA_INLINE void* ts_parser_allocator_realloc(ts_parser_allocator_ptr self, void* p, uintptr_t nsize, uintptr_t osize);
static ts_parser_allocator ts_parser_embedded_general_allocator = {0};
...
typedef nlmulret_nlboolean_nlpointer_nlusize (*function_29wc53vp1FUUemWxB)(nelua_hashmap_iteratorT_1_ptr, void*);
...
struct nelua_GeneralAllocator {char x;};
NELUA_STATIC_ASSERT(sizeof(nelua_GeneralAllocator) == 1 && NELUA_ALIGNOF(nelua_GeneralAllocator) == 1, "Nelua and C disagree on type size or align");
...
NELUA_STATIC_ASSERT(sizeof(nelua_hashmap_pointer__usize_) == 56 && NELUA_ALIGNOF(nelua_hashmap_pointer__usize_) == 8, "Nelua and C disagree on type size or align");
typedef struct nlmulret_function_29wc53vp1FUUemWxB_nelua_hashmap_iteratorT_1_nlpointer {
  function_29wc53vp1FUUemWxB r1;
  nelua_hashmap_iteratorT_1 r2;
  void* r3;
} nlmulret_function_29wc53vp1FUUemWxB_nelua_hashmap_iteratorT_1_nlpointer;
static NELUA_INLINE nlmulret_function_29wc53vp1FUUemWxB_nelua_hashmap_iteratorT_1_nlpointer nelua_pairs_1(nelua_hashmap_pointer__usize__ptr a);
...
typedef nlmulret_nlboolean_nlpointer_nelua_GCItem_ptr (*function_Vv686bZ7CxeS2EGx)(nelua_hashmap_iteratorT_ptr, void*);
...
NELUA_STATIC_ASSERT(sizeof(nelua_hashmap_pointer__GCItem_) == 56 && NELUA_ALIGNOF(nelua_hashmap_pointer__GCItem_) == 8, "Nelua and C disagree on type size or align");
typedef struct nlmulret_function_Vv686bZ7CxeS2EGx_nelua_hashmap_iteratorT_nlpointer {
  function_Vv686bZ7CxeS2EGx r1;
  nelua_hashmap_iteratorT r2;
  void* r3;
} nlmulret_function_Vv686bZ7CxeS2EGx_nelua_hashmap_iteratorT_nlpointer;
static NELUA_INLINE nlmulret_function_Vv686bZ7CxeS2EGx_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a);
typedef struct nlniltype {char x;} nlniltype;
...
struct nelua_GCAllocator {char x;};
NELUA_STATIC_ASSERT(sizeof(nelua_GCAllocator) == 1 && NELUA_ALIGNOF(nelua_GCAllocator) == 1, "Nelua and C disagree on type size or align");
struct nelua_sequence_string_ {
  nelua_sequenceimpl_string__ptr impl;
  nelua_GCAllocator allocator;
};
NELUA_STATIC_ASSERT(sizeof(nelua_sequence_string_) == 16 && NELUA_ALIGNOF(nelua_sequence_string_) == 8, "Nelua and C disagree on type size or align");
...
static void nelua_assert_line_13(bool cond);
...
static NELUA_INLINE nlmulret_function_Vv686bZ7CxeS2EGx_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self);
...
static void nelua_assert_line_15(bool cond);
...
static NELUA_INLINE nlmulret_function_29wc53vp1FUUemWxB_nelua_hashmap_iteratorT_1_nlpointer nelua_hashmap_pointer__usize____pairs(nelua_hashmap_pointer__usize__ptr self);
...
NELUA_STATIC_ASSERT(sizeof(nelua_vector_pointer_) == 32 && NELUA_ALIGNOF(nelua_vector_pointer_) == 8, "Nelua and C disagree on type size or align");
...
NELUA_STATIC_ASSERT(sizeof(nelua_vector_GCScanRange_) == 32 && NELUA_ALIGNOF(nelua_vector_GCScanRange_) == 8, "Nelua and C disagree on type size or align");
...
NELUA_STATIC_ASSERT(sizeof(nelua_GC) == 240 && NELUA_ALIGNOF(nelua_GC) == 8, "Nelua and C disagree on type size or align");
...
typedef void (*function_54RBx3jxGa6YvD11Q)(nelua_GC_ptr);
...
typedef void (*function_46DQzi6fAXPqLyMqz)(void*, void*);
static void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_46DQzi6fAXPqLyMqz finalizer, void* userdata);
...
static nlstring nelua_nlstring_char_1(int32_t __arg1);
static NELUA_INLINE uint8_t nelua_assert_narrow_nlint32_nluint8(int32_t x);
...
typedef TSLexer* TSLexer_ptr;
static bool src_scanner_scan_escape_sequence(TSLexer_ptr lexer);
static void nelua_print_1(bool a1);
typedef bool* nlboolean_arr0_ptr;
NELUA_CEXPORT bool tree_sitter_pluto_external_scanner_scan(void* _, TSLexer_ptr lexer, const nlboolean_arr0_ptr valid_symbols);
NELUA_CEXPORT void* tree_sitter_pluto_external_scanner_create(void);
NELUA_CEXPORT void tree_sitter_pluto_external_scanner_destroy(void* _);
NELUA_CEXPORT uint64_t tree_sitter_pluto_external_scanner_serialize(void* _, char* __1);
NELUA_CEXPORT void tree_sitter_pluto_external_scanner_deserialize(void* _, void* __2, uint64_t __3);
/* ------------------------------ DEFINITIONS ------------------------------- */
void* ts_parser_allocator_alloc(ts_parser_allocator_ptr self, uintptr_t size) {
  if(NELUA_UNLIKELY((size == 0))) {
    return (void*)NULL;
  }
  return ts_malloc(size);
}
void* ts_parser_allocator_alloc0(ts_parser_allocator_ptr self, uintptr_t size) {
  if(NELUA_UNLIKELY((size == 0))) {
    return (void*)NULL;
  }
  return ts_calloc(size, 1U);
}
void ts_parser_allocator_dealloc(ts_parser_allocator_ptr self, void* p) {
  if(NELUA_UNLIKELY((p == (void*)NULL))) {
    return;
  }
  ts_free(p);
}
void* ts_parser_allocator_realloc(ts_parser_allocator_ptr self, void* p, uintptr_t nsize, uintptr_t osize) {
  if(NELUA_UNLIKELY((nsize == 0))) {
    if(NELUA_LIKELY((p != (void*)NULL))) {
      ts_free(p);
    }
    return (void*)NULL;
  } else if(NELUA_UNLIKELY((nsize == osize))) {
    return p;
  }
...
void nelua_assert_line_1(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/memory.nelua\033[1m:27:14: \033[31m\033[1mruntime error: \033[0m\033[1m", 142, false);
...
void nelua_assert_line_2(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/memory.nelua\033[1m:60:9: \033[31m\033[1mruntime error: \033[0m\033[1m", 141, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_3(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/memory.nelua\033[1m:76:11: \033[31m\033[1mruntime error: \033[0m\033[1m", 142, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_4(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/memory.nelua\033[1m:116:20: \033[31m\033[1mruntime error: \033[0m\033[1m", 143, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void* nelua_memory_find(void* haystack, uintptr_t haystacksize, void* needle, uintptr_t needlesize) {
  if(NELUA_UNLIKELY(((needlesize == 0) || (haystack == needle)))) {
    ...
    nelua_assert_line_4(((haystack != NULL) && (needle != NULL)), ((nlstring){(uint8_t*)"invalid pointer", 15}));
    if((needlesize == 1)) {
...
void nelua_assert_line_5(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/span.nelua\033[1m:93:13: \033[31m\033[1mruntime error: \033[0m\033[1m", 140, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
nlmulret_function_29wc53vp1FUUemWxB_nelua_hashmap_iteratorT_1_nlpointer nelua_pairs_1(nelua_hashmap_pointer__usize__ptr a) {
  nlmulret_function_29wc53vp1FUUemWxB_nelua_hashmap_iteratorT_1_nlpointer _ret_1 = nelua_hashmap_pointer__usize____pairs(a);
  return (nlmulret_function_29wc53vp1FUUemWxB_nelua_hashmap_iteratorT_1_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
nlmulret_function_Vv686bZ7CxeS2EGx_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a) {
  nlmulret_function_Vv686bZ7CxeS2EGx_nelua_hashmap_iteratorT_nlpointer _ret_1 = nelua_hashmap_pointer__GCItem____mpairs(a);
  return (nlmulret_function_Vv686bZ7CxeS2EGx_nelua_hashmap_iteratorT_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
void nelua_assert_line_11(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/sequence.nelua\033[1m:151:17: \033[31m\033[1mruntime error: \033[0m\033[1m", 145, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_sequenceT_grow(nelua_sequence_string__ptr self) {
  ...
  if(NELUA_LIKELY((curcap != 0))) {
    cap = (curcap * 2);
    nelua_assert_line_11((cap > curcap), ((nlstring){(uint8_t*)"capacity overflow", 17}));
  }
  self->impl->data = nelua_GCAllocator_xspanrealloc_2((&self->allocator), self->impl->data, cap);
  if(NELUA_UNLIKELY((curcap == 0))) {
    (*(nlstring*)nelua_assert_deref(nelua_span_string____atindex(self->impl->data, 0U))) = (nlstring){0};
...
void nelua_assert_line_12(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/sequence.nelua\033[1m:259:18: \033[31m\033[1mruntime error: \033[0m\033[1m", 145, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
nlstring_ptr nelua_sequence_string____atindex(nelua_sequence_string__ptr self, uintptr_t pos) {
  ...
  if(NELUA_UNLIKELY((pos > self->impl->size))) {
    nelua_assert_line_12((pos == (self->impl->size + 1)), ((nlstring){(uint8_t*)"position out of bounds", 22}));
...
void* nelua_GeneralAllocator_alloc_1(nelua_GeneralAllocator_ptr self, uintptr_t size, uintptr_t flags) {
  return ts_parser_allocator_alloc((&ts_parser_embedded_general_allocator), size);
}
...
void* nelua_GeneralAllocator_alloc0_1(nelua_GeneralAllocator_ptr self, uintptr_t size, nlniltype flags) {
  return ts_parser_allocator_alloc0((&ts_parser_embedded_general_allocator), size);
}
...
void nelua_GeneralAllocator_dealloc(nelua_GeneralAllocator_ptr self, void* p) {
  ts_parser_allocator_dealloc((&ts_parser_embedded_general_allocator), p);
}
void* nelua_GeneralAllocator_realloc(nelua_GeneralAllocator_ptr self, void* p, uintptr_t newsize, uintptr_t oldsize) {
  return ts_parser_allocator_realloc((&ts_parser_embedded_general_allocator), p, newsize, oldsize);
}
...
void nelua_assert_line_13(bool cond) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/hashmap.nelua\033[1m:214:15: \033[31m\033[1mruntime error: \033[0m\033[1massertion failed!\033[0m\n      check(j == self.size)\n              \033[1m\033[32m^\033[0m\033[35m~~~~~~~~~~~\033[0m\n",  243, true);
    nelua_abort();
  }
}
void nelua_hashmap_pointer__GCItem__rehash(nelua_hashmap_pointer__GCItem__ptr self, uintptr_t bucket_count) {
  ...
  if((((node_count < self->nodes.size) && (self->nodes.size > 0)) && (node_count > 0))) {
    ...
    nelua_assert_line_13((j == self->size));
  }
...
void nelua_assert_line_14(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/hashmap.nelua\033[1m:270:24: \033[31m\033[1mruntime error: \033[0m\033[1m", 144, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
uintptr_t nelua_hashmap_pointer__GCItem___at(nelua_hashmap_pointer__GCItem__ptr self, void* key) {
  ...
  if((node_index != 0xffffffffffffffffULL)) {
    ...
    nelua_assert_line_14((node_index_1 < self->nodes.size), ((nlstring){(uint8_t*)"not enough space to add a node", 30}));
...
nlmulret_function_Vv686bZ7CxeS2EGx_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self) {
  return (nlmulret_function_Vv686bZ7CxeS2EGx_nelua_hashmap_iteratorT_nlpointer){nelua_hashmap_iteratorT_mnext, (nelua_hashmap_iteratorT){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
void nelua_assert_line_15(bool cond) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/hashmap.nelua\033[1m:214:15: \033[31m\033[1mruntime error: \033[0m\033[1massertion failed!\033[0m\n      check(j == self.size)\n              \033[1m\033[32m^\033[0m\033[35m~~~~~~~~~~~\033[0m\n",  243, true);
    nelua_abort();
  }
...
void nelua_hashmap_pointer__usize__rehash(nelua_hashmap_pointer__usize__ptr self, uintptr_t bucket_count) {
  ...
  if((((node_count < self->nodes.size) && (self->nodes.size > 0)) && (node_count > 0))) {
    ...
    nelua_assert_line_15((j == self->size));
  }
...
uintptr_t nelua_hashmap_pointer__usize___at(nelua_hashmap_pointer__usize__ptr self, void* key) {
  ...
  if((node_index != 0xffffffffffffffffULL)) {
    ...
    nelua_assert_line_16((node_index_2 < self->nodes.size), ((nlstring){(uint8_t*)"not enough space to add a node", 30}));
...
nlmulret_function_29wc53vp1FUUemWxB_nelua_hashmap_iteratorT_1_nlpointer nelua_hashmap_pointer__usize____pairs(nelua_hashmap_pointer__usize__ptr self) {
  return (nlmulret_function_29wc53vp1FUUemWxB_nelua_hashmap_iteratorT_1_nlpointer){nelua_hashmap_iteratorT_1_next, (nelua_hashmap_iteratorT_1){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
void nelua_assert_line_17(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/vector.nelua\033[1m:124:17: \033[31m\033[1mruntime error: \033[0m\033[1m", 143, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_vectorT_grow(nelua_vector_pointer__ptr self) {
  ...
  if(NELUA_LIKELY((self->data.size != 0))) {
    ...
    nelua_assert_line_17((cap > self->data.size), ((nlstring){(uint8_t*)"capacity overflow", 17}));
  }
...
void nelua_assert_line_18(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/vector.nelua\033[1m:223:15: \033[31m\033[1mruntime error: \033[0m\033[1m", 143, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
nlpointer_ptr nelua_vector_pointer____atindex(nelua_vector_pointer__ptr self, uintptr_t pos) {
  nelua_assert_line_18((pos < self->size), ((nlstring){(uint8_t*)"position out of bounds", 22}));
...
void nelua_vectorT_grow_1(nelua_vector_GCScanRange__ptr self) {
  ...
  if(NELUA_LIKELY((self->data.size != 0))) {
    cap = (self->data.size * 2);
    nelua_assert_line_19((cap > self->data.size), ((nlstring){(uint8_t*)"capacity overflow", 17}));
  }
...
void nelua_assert_line_20(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/vector.nelua\033[1m:144:21: \033[31m\033[1mruntime error: \033[0m\033[1m", 143, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
nelua_GCScanRange nelua_vector_GCScanRange__pop(nelua_vector_GCScanRange__ptr self) {
  nelua_assert_line_20((self->size > 0), ((nlstring){(uint8_t*)"attempt to pop an empty vector", 30}));
  self->size = (self->size - 1);
...
void nelua_assert_line_21(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:140:20: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_GC_unregister_1(nelua_GC_ptr self, void* ptr, bool finalize) {
  ...
  if(NELUA_LIKELY((item.size != 0))) {
    ...
    nelua_assert_line_21((oldsize != 0), ((nlstring){(uint8_t*)"invalid unregister pointer", 26}));
  }
}
...
void nelua_GC_mark(nelua_GC_ptr self) {
  {
    nlmulret_function_29wc53vp1FUUemWxB_nelua_hashmap_iteratorT_1_nlpointer _asgnret_1 = nelua_pairs_1((&self->rootitems));
    function_29wc53vp1FUUemWxB __fornext = _asgnret_1.r1;
  ...
  if((self->stackbottom != 0)) {
    volatile function_54RBx3jxGa6YvD11Q scanstack = nelua_GC_scanstack;
    scanstack(self);
  }
...
void nelua_assert_line_22(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:247:13: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_23(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:260:18: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_24(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:275:23: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_GC_sweep(nelua_GC_ptr self) {
  ...
  {
    nlmulret_function_Vv686bZ7CxeS2EGx_nelua_hashmap_iteratorT_nlpointer _asgnret_1 = nelua_mpairs_1((&self->items));
    function_Vv686bZ7CxeS2EGx __fornext = _asgnret_1.r1;
    ...
    while(true) {
      ...
      __fornextit = ptr;
      {
        ...
        if(nelua_hasflag(item_flags, 65536U)) {
          ...
          nelua_assert_line_22(removed, ((nlstring){(uint8_t*)"gc item not found to erase", 26}));
  ...
  while((i < self->finalizeitems.size)) {
    ...
    if(NELUA_LIKELY((ptr != NULL))) {
      nelua_GCItem_ptr item = nelua_hashmap_pointer__GCItem__peek((&self->items), ptr);
      nelua_assert_line_23((item != ((nelua_GCItem_ptr)NULL)), ((nlstring){(uint8_t*)"gc item not found to finalize", 29}));
  ...
  while((i_1 < self->finalizeitems.size)) {
    ...
    if(NELUA_LIKELY((ptr != NULL))) {
      nelua_GCItem item = nelua_hashmap_pointer__GCItem__remove((&self->items), ptr);
      nelua_assert_line_24((item.size != 0), ((nlstring){(uint8_t*)"gc item not found to deallocate", 31}));
      if(NELUA_LIKELY((item.size != 0))) {
        self->membytes = (self->membytes - item.size);
...
void nelua_assert_line_25(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:382:15: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_26(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:389:21: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_27(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:406:18: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_28(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:407:32: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
    nelua_write_stderr("\033[0m\n    assert(finalizer == nilptr and userdata == nilptr, 'attempt to register a root pointer with finalizer')\n                               \033[1m\033[32m^\033[0m\033[35m~~~~~~~~~~~~~~~~~~~~~\033[0m\n", 189, true);
    nelua_abort();
  }
}
void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_46DQzi6fAXPqLyMqz finalizer, void* userdata) {
  if(NELUA_UNLIKELY((!(ptr != NULL)))) {
    return;
  }
  nelua_assert_line_25((size > 0), ((nlstring){(uint8_t*)"attempt to register a pointer with size zero", 44}));
  if(NELUA_LIKELY((!nelua_hasflag(flags, 131072U)))) {
    ...
    nelua_assert_line_26((item->size == 0), ((nlstring){(uint8_t*)"cannot register pointer twice", 29}));
    ...
    nelua_assert_line_27((flags == 131072U), ((nlstring){(uint8_t*)"attempt to register a root pointer with invalid flags", 53}));
    nelua_assert_line_28(((finalizer == ((function_46DQzi6fAXPqLyMqz)NULL)) && (userdata == (void*)NULL)), ((nlstring){(uint8_t*)"attempt to register a root pointer with finalizer", 49}));
...
void nelua_assert_line_29(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:417:47: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_30(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:433:22: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_31(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:452:22: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
    nelua_write_stderr("\033[0m\n      assert(oldsize ~= 0, 'invalid reregister pointer')\n                     \033[1m\033[32m^\033[0m\033[35m~~~\033[0m\n", 110, true);
    nelua_abort();
  }
...
void nelua_GC_reregister(nelua_GC_ptr self, void* oldptr, void* newptr, uintptr_t newsize) {
  nelua_assert_line_29((((oldptr != (void*)NULL) && (newptr != (void*)NULL)) && (newsize > 0)), ((nlstring){(uint8_t*)"invalid reregister arguments", 28}));
  if((newptr == oldptr)) {
    ...
    if(NELUA_LIKELY((item.size != 0))) {
      ...
      uintptr_t oldsize = nelua_hashmap_pointer__usize__remove((&self->rootitems), oldptr);
      nelua_assert_line_31((oldsize != 0), ((nlstring){(uint8_t*)"invalid reregister pointer", 26}));
      (*(uintptr_t*)nelua_assert_deref(nelua_hashmap_pointer__usize____atindex((&self->rootitems), newptr))) = newsize;
    }
  }
}
...
void nelua_assert_line_32(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/allocators/gc.nelua\033[1m:779:16: \033[31m\033[1mruntime error: \033[0m\033[1m", 150, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
nelua_sequenceimpl_string__ptr nelua_GCAllocator_new_1(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_32((ptr != ((nelua_sequenceimpl_string__ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
void nelua_assert_line_33(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/string.nelua\033[1m:35:14: \033[31m\033[1mruntime error: \033[0m\033[1m", 142, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
uint8_t nelua_assert_narrow_nlint32_nluint8(int32_t x) {
  if(NELUA_UNLIKELY(x < 0 || x > 0xff)) {
    nelua_panic_cstring("narrow casting from int32 to uint8 failed");
  }
  return (uint8_t)x;
}
nlstring nelua_nlstring_char_1(int32_t __arg1) {
  nlstring s = nelua_nlstring_create(1U);
  s.data[0] = nelua_assert_narrow_nlint32_nluint8(__arg1);
  return s;
}
...
void nelua_assert_line_34(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/detail/strpatt.nelua\033[1m:135:16: \033[31m\033[1mruntime error: \033[0m\033[1m", 151, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_35(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/detail/strpatt.nelua\033[1m:142:18: \033[31m\033[1mruntime error: \033[0m\033[1m", 151, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_match_class_end(nelua_StrPatt_1_ptr ms_1, intptr_t p_1) {
  ...
  switch(c) {
    case 37U: {
      nelua_assert_line_34((p_1 != nelua_nlstring___len(ms_1->pattern)), ((nlstring){(uint8_t*)"malformed pattern (ends with '%')", 33}));
      p_1 = (p_1 + 1);
      break;
    }
    case 91U: {
      ...
      }
      {
        bool _repeat_stop;
        do {
          nelua_assert_line_35((p_1 != nelua_nlstring___len(ms_1->pattern)), ((nlstring){(uint8_t*)"malformed pattern (missing ']')", 31}));
...
void nelua_assert_line_36(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/detail/strpatt.nelua\033[1m:196:14: \033[31m\033[1mruntime error: \033[0m\033[1m", 151, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_match_balance(nelua_StrPatt_1_ptr ms_4, intptr_t s_2, intptr_t p_4) {
  nelua_assert_line_36((p_4 < (nelua_nlstring___len(ms_4->pattern) - 1)), ((nlstring){(uint8_t*)"malformed pattern (missing arguments to '%b')", 45}));
...
void nelua_assert_line_37(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/detail/strpatt.nelua\033[1m:251:24: \033[31m\033[1mruntime error: \033[0m\033[1m", 151, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_match_start_capture(nelua_StrPatt_1_ptr ms_7, intptr_t s_5, intptr_t p_7, intptr_t what) {
  ...
  nelua_assert_line_37((numcaptures < 32), ((nlstring){(uint8_t*)"too many captures", 17}));
...
void nelua_assert_line_38(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/detail/strpatt.nelua\033[1m:271:14: \033[31m\033[1mruntime error: \033[0m\033[1m", 151, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_match_end_capture(nelua_StrPatt_1_ptr ms_8, intptr_t s_6, intptr_t p_8) {
  ...
  nelua_assert_line_38((l != -1), ((nlstring){(uint8_t*)"invalid pattern capture", 23}));
...
void nelua_assert_line_39(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/detail/strpatt.nelua\033[1m:282:42: \033[31m\033[1mruntime error: \033[0m\033[1m", 151, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_match_capture(nelua_StrPatt_1_ptr ms_9, intptr_t s_7, intptr_t l) {
  l = (intptr_t)(l - 49U);
  nelua_assert_line_39((((l >= 0) && (l < ms_9->numcaptures)) && (ms_9->capture[nelua_assert_bounds_nlisize(l, 32)].len != -1)), ((nlstring){(uint8_t*)"invalid capture index", 21}));
...
void nelua_assert_line_40(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/detail/strpatt.nelua\033[1m:292:19: \033[31m\033[1mruntime error: \033[0m\033[1m", 151, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
void nelua_assert_line_41(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/detail/strpatt.nelua\033[1m:324:35: \033[31m\033[1mruntime error: \033[0m\033[1m", 151, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
...
intptr_t nelua_StrPatt_1__match(nelua_StrPatt_1_ptr ms, intptr_t s, intptr_t p) {
  ms->depth = (ms->depth - 1);
  nelua_assert_line_40((ms->depth > 0), ((nlstring){(uint8_t*)"pattern too complex", 19}));
    ...
    switch(ms->pattern.data[p]) {
      ...
      case 37U: {
        switch(ms->pattern.data[(p + 1)]) {
          ...
          case 102U: {
            p = (p + 2);
            nelua_assert_line_41((ms->pattern.data[p] == 91U), ((nlstring){(uint8_t*)"missing '[' after '%f' in pattern", 33}));
...
void nelua_assert_line_42(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/string.nelua\033[1m:814:16: \033[31m\033[1mruntime error: \033[0m\033[1m", 143, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
    nelua_write_stderr("\033[0m\n        assert(ok, capstr)\n               \033[1m\033[32m^\033[0m\033[35m~\033[0m\n", 72, true);
    nelua_abort();
  }
...
void nelua_assert_line_43(bool cond, nlstring msg) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/nix/store/7f3ysbaax7ghc3byva8w58zp4f3x8l0f-nelua-0-unstable-2024-10-18/lib/nelua/lib/string.nelua\033[1m:815:16: \033[31m\033[1mruntime error: \033[0m\033[1m", 143, false);
    nelua_write_stderr((const char*)msg.data, msg.size, false);
  ...
  if((endpos != -1)) {
    if((ms.numcaptures > 0)) {
      ...
      for(intptr_t i = 0, _end = ms.numcaptures; i < _end; i += 1) {
        ...
        nelua_assert_line_42(ok, capstr);
        nelua_assert_line_43((!nelua_StrPattCapture_is_position((&capture))), ((nlstring){(uint8_t*)"position capture not supported yet", 34}));
...
void nelua_print_1(bool a1) {
  fputs(a1 ? "true" : "false", stdout);
  fputs("\n", stdout);
  fflush(stdout);
}
bool src_scanner_scan_escape_sequence(TSLexer_ptr lexer) {
  lexer->result_symbol = 0x0U;
  bool tokenize = false;
  if((lexer->lookahead == 92)) {
    ...
    switch(lexer->lookahead) {
      ...
      case 120: {
        tokenize = true;
        for(int64_t _ = 1; _ <= 2; _ += 1) {
          lexer->advance(lexer, false);
          if(nelua_nlstring_match_1(nelua_nlstring_char_1(lexer->lookahead), ((nlstring){(uint8_t*)"%X", 2}), NELUA_NIL).r1) {
            tokenize = false;
            break;
          }
        }
      ...
      default: {
        ...
        for(int64_t _ = 1; _ <= 2; _ += 1) {
          lexer->advance(lexer, false);
          if(nelua_nlstring_match_1(nelua_nlstring_char_1(lexer->lookahead), ((nlstring){(uint8_t*)"%D", 2}), NELUA_NIL).r1) {
            tokenize = false;
            break;
          }
        }
  ...
  nelua_print_1(tokenize);
  return tokenize;
}
bool tree_sitter_pluto_external_scanner_scan(void* _, TSLexer_ptr lexer, const nlboolean_arr0_ptr valid_symbols) {
  if(valid_symbols[0x0U]) {
    return src_scanner_scan_escape_sequence(lexer);
  }
  return false;
}
void* tree_sitter_pluto_external_scanner_create(void) {
  nelua_GC_init((&nelua_gc), (void*)NULL);
  return (void*)NULL;
}
void tree_sitter_pluto_external_scanner_destroy(void* _) {
  nelua_GC_destroy((&nelua_gc));
}
uint64_t tree_sitter_pluto_external_scanner_serialize(void* _, char* __1) {
  return 0U;
}
void tree_sitter_pluto_external_scanner_deserialize(void* _, void* __2, uint64_t __3) {
}
